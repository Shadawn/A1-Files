Функция ДобавитьОписание(МассивОписаний, Знач ИмяКомпонента = Неопределено, Знач Владелец, РодительЭлемента = Неопределено, ПередЭлементом = Неопределено, Параметры = Неопределено, Действия = Неопределено) Экспорт
	...
	А1Файлы.ДобавитьОписаниеКнопкиПрисоединить(МассивОписаний, ИмяКомпонента + "___Добавить", ИмяМодуля() + ".КомандаОбновитьДанные:НаСервере", , ИмяТаблицы(ИмяКомпонента) + "КоманднаяПанель");
	А1Э_Формы.ДобавитьОписаниеКомандыИКнопки(МассивОписаний, ИмяКомпонента + "___Открыть", ИмяМодуля() + ".КомандаОткрыть", , "Открыть", ИмяТаблицы(ИмяКомпонента) + "КоманднаяПанель"); 
	А1Э_Формы.ДобавитьОписаниеКомандыИКнопки(МассивОписаний, ИмяКомпонента + "___Скачать", ИмяМодуля() + ".КомандаСкачать", , "Скачать", ИмяТаблицы(ИмяКомпонента) + "КоманднаяПанель");
КонецФункции
